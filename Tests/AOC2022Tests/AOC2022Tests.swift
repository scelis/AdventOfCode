...
@Suite struct AOC2022Tests {
    @Test func day01() async throws {
        let day = Day01()
        let parts = try await day.run(input: loadInput(fileName: "2022-01.txt"))
    ...
    @Test func day02() async throws {
        let day = Day02()
        let parts = try await day.run(input: loadInput(fileName: "2022-02.txt"))
    ...
    @Test func day03() async throws {
        let day = Day03()
        let parts = try await day.run(input: loadInput(fileName: "2022-03.txt"))
        #expect(parts.0 == 7908)
        #expect(parts.1 == 2838)
    }
    ...
    @Test func day04() async throws {
        let day = Day04()
        let parts = try await day.run(input: loadInput(fileName: "2022-04.txt"))
        #expect(parts.0 == 483)
        #expect(parts.1 == 874)
    }
    ...
    @Test func day05() async throws {
        let day = Day05()
        let parts = try await day.run(input: loadInput(fileName: "2022-05.txt"))
    ...
    @Test func day06() async throws {
        let day = Day06()
        let parts = try await day.run(input: loadInput(fileName: "2022-06.txt"))
        #expect(parts.0 == 1640)
        #expect(parts.1 == 3613)
    }
    ...
    @Test func day07() async throws {
        let day = Day07()
        let parts = try await day.run(input: loadInput(fileName: "2022-07.txt"))
    ...
    @Test func day08() async throws {
        let day = Day08()
        let parts = try await day.run(input: loadInput(fileName: "2022-08.txt"))
        #expect(parts.0 == 1814)
    ...
    @Test func day09() async throws {
        let day = Day09()
        let parts = try await day.run(input: loadInput(fileName: "2022-09.txt"))
        #expect(parts.0 == 6026)
        #expect(parts.1 == 2273)
    }
    ...
    @Test func day10() async throws {
        let day = Day10()
        let parts = try await day.run(input: loadInput(fileName: "2022-10.txt"))
...
""")
    ...
    @Test func day11() async throws {
        let day = Day11()
        let parts = try await day.run(input: loadInput(fileName: "2022-11.txt"))
    ...
    @Test func day12() async throws {
        let day = Day12()
        let parts = try await day.run(input: loadInput(fileName: "2022-12.txt"))
        #expect(parts.0 == 472)
        #expect(parts.1 == 465)
    }
    ...
    @Test func day13() async throws {
        let day = Day13()
        let parts = try await day.run(input: loadInput(fileName: "2022-13.txt"))
        #expect(parts.0 == 5684)
    ...
    @Test func day14() async throws {
        let day = Day14()
        let parts = try await day.run(input: loadInput(fileName: "2022-14.txt"))
        #expect(parts.0 == 1016)
    ...
    @Test func day15() async throws {
        let day = Day15()
        let parts = try await day.run(input: loadInput(fileName: "2022-15.txt"))
