...
@Suite struct AOC2021Tests {
    @Test func day01() async throws {
        let day = Day01()
        let parts = try await day.run(input: loadInput(fileName: "2021-01.txt"))
        #expect(parts.0 == 1446)
        #expect(parts.1 == 1486)
    }
    ...
    @Test func day02() async throws {
        let day = Day02()
        let parts = try await day.run(input: loadInput(fileName: "2021-02.txt"))
    ...
    @Test func day03() async throws {
        let day = Day03()
        let parts = try await day.run(input: loadInput(fileName: "2021-03.txt"))
    ...
    @Test func day04() async throws {
        let day = Day04()
        let parts = try await day.run(input: loadInput(fileName: "2021-04.txt"))
    ...
    @Test func day05() async throws {
        let day = Day05()
        let parts = try await day.run(input: loadInput(fileName: "2021-05.txt"))
        #expect(parts.0 == 6225)
    ...
    @Test func day06() async throws {
        let day = Day06()
        let parts = try await day.run(input: loadInput(fileName: "2021-06.txt"))
    ...
    @Test func day07() async throws {
        let day = Day07()
        let parts = try await day.run(input: loadInput(fileName: "2021-07.txt"))
    ...
    @Test func day08() async throws {
        let day = Day08()
        let parts = try await day.run(input: loadInput(fileName: "2021-08.txt"))
        #expect(parts.0 == 512)
    ...
    @Test func day09() async throws {
        let day = Day09()
        let parts = try await day.run(input: loadInput(fileName: "2021-09.txt"))
        #expect(parts.0 == 564)
    ...
    @Test func day10() async throws {
        let day = Day10()
        let parts = try await day.run(input: loadInput(fileName: "2021-10.txt"))
