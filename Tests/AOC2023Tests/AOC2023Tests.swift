...
@Suite struct AOC2023Tests {
    @Test func day01() async throws {
        let day = Day01()
        let parts = try await day.run(fileName: "2023-01.txt")
    ...
    @Test func day02() async throws {
        let day = Day02()
        let parts = try await day.run(fileName: "2023-02.txt")
        #expect(parts.0 == 1931)
    ...
    @Test func day03() async throws {
        let day = Day03()
        let parts = try await day.run(fileName: "2023-03.txt")
    ...
    @Test func day04() async throws {
        let day = Day04()
        let parts = try await day.run(fileName: "2023-04.txt")
    ...
    @Test func day05() async throws {
        let day = Day05()
        let parts = try await day.run(fileName: "2023-05.txt")
    ...
    @Test func day06() async throws {
        let day = Day06()
        let parts = try await day.run(fileName: "2023-06.txt")
    ...
    @Test func day07() async throws {
        let day = Day07()
        let parts = try await day.run(fileName: "2023-07.txt")
    ...
    @Test func day08() async throws {
        let day = Day08()
        let parts = try await day.run(fileName: "2023-08.txt")
    ...
    @Test func day09() async throws {
        let day = Day09()
        let parts = try await day.run(fileName: "2023-09.txt")
    ...
    @Test func day10() async throws {
        let day = Day10()
        let parts = try await day.run(fileName: "2023-10.txt")
        #expect(parts.0 == 6717)
        #expect(parts.1 == 381)
    }
    ...
    @Test func day11() async throws {
        let day = Day11()
        let parts = try await day.run(fileName: "2023-11.txt")
    ...
    @Test func day12() async throws {
        let day = Day12()
        let parts = try await day.run(fileName: "2023-12.txt")
        #expect(parts.0 == 7260)
    ...
    @Test func day13() async throws {
        let day = Day13()
        let parts = try await day.run(fileName: "2023-13.txt")
    ...
    @Test func day14() async throws {
        let day = Day14()
        let parts = try await day.run(fileName: "2023-14.txt")
    ...
    @Test func day15() async throws {
        let day = Day15()
        let parts = try await day.run(fileName: "2023-15.txt")
    ...
    @Test func day16() async throws {
        let day = Day16()
        let parts = try await day.run(fileName: "2023-16.txt")
        #expect(parts.0 == 7632)
        #expect(parts.1 == 8023)
    }
    ...
    @Test func day17() async throws {
        let day = Day17()
        let parts = try await day.run(fileName: "2023-17.txt")
        #expect(parts.0 == 1044)
        #expect(parts.1 == 1227)
    }
    ...
    @Test func day18() async throws {
        let day = Day18()
        let parts = try await day.run(fileName: "2023-18.txt")
    ...
    @Test func day19() async throws {
        let day = Day19()
        let parts = try await day.run(fileName: "2023-19.txt")
    ...
    @Test func day20() async throws {
        let day = Day20()
        let parts = try await day.run(fileName: "2023-20.txt")
    ...
    @Test func day21() async throws {
        let day = Day21()
        let parts = try await day.run(fileName: "2023-21.txt")
        #expect(parts.0 == 3729)
    }
}
