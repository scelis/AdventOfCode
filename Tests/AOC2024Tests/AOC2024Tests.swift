...
@Suite struct AOC2024Tests {
    @Test func day01() async throws {
        let day = Day01()
        let parts = try await day.run(input: loadInput(forResource: "2024-01"))
    ...
    @Test func day02() async throws {
        let day = Day02()
        let parts = try await day.run(input: loadInput(forResource: "2024-02"))
        #expect(parts.0 == 287)
        #expect(parts.1 == 354)
    }
    ...
    @Test func day03() async throws {
        let day = Day03()
        let parts = try await day.run(input: loadInput(forResource: "2024-03"))
    ...
    @Test func day04() async throws {
        let day = Day04()
        let parts = try await day.run(input: loadInput(forResource: "2024-04"))
        #expect(parts.0 == 2496)
        #expect(parts.1 == 1967)
    }
    ...
    @Test func day05() async throws {
        let day = Day05()
        let parts = try await day.run(input: loadInput(forResource: "2024-05"))
        #expect(parts.0 == 6034)
        #expect(parts.1 == 6305)
    }
    ...
    @Test func day06() async throws {
        let day = Day06()
        let parts = try await day.run(input: loadInput(forResource: "2024-06"))
        #expect(parts.0 == 5444)
        #expect(parts.1 == 1946)
    }
    ...
    @Test func day07() async throws {
        let day = Day07()
        let parts = try await day.run(input: loadInput(forResource: "2024-07"))
    ...
    @Test func day08() async throws {
        let day = Day08()
        let parts = try await day.run(input: loadInput(forResource: "2024-08"))
        #expect(parts.0 == 329)
        #expect(parts.1 == 1190)
    }
    ...
    @Test func day09() async throws {
        let day = Day09()
        let parts = try await day.run(input: loadInput(forResource: "2024-09"))
    ...
    @Test func day10() async throws {
        let day = Day10()
        let parts = try await day.run(input: loadInput(forResource: "2024-10"))
        #expect(parts.0 == 796)
        #expect(parts.1 == 1942)
    }
    ...
    @Test func day11() async throws {
        let day = Day11()
        let parts = try await day.run(input: loadInput(forResource: "2024-11"))
    ...
    @Test func day12() async throws {
        let day = Day12()
        let parts = try await day.run(input: loadInput(forResource: "2024-12"))
    ...
    @Test func day13() async throws {
        let day = Day13()
        let parts = try await day.run(input: loadInput(forResource: "2024-13"))
    ...
    @Test func day14() async throws {
        let day = Day14()
        let parts = try await day.run(input: loadInput(forResource: "2024-14"))
    ...
    @Test func day15() async throws {
        let day = Day15()
        let parts = try await day.run(input: loadInput(forResource: "2024-15"))
    ...
    @Test func day16() async throws {
        let day = Day16()
        let parts = try await day.run(input: loadInput(forResource: "2024-16"))
    ...
    @Test func day17() async throws {
        let day = Day17()
        let parts = try await day.run(input: loadInput(forResource: "2024-17"))
    ...
    @Test func day18() async throws {
        let day = Day18()
        let parts = try await day.run(input: loadInput(forResource: "2024-18"))
        #expect(parts.0 == 282)
    ...
    @Test func day19() async throws {
        let day = Day19()
        let parts = try await day.run(input: loadInput(forResource: "2024-19"))
        #expect(parts.0 == 308)
    ...
    @Test func day20() async throws {
        let day = Day20()
        let parts = try await day.run(input: loadInput(forResource: "2024-20"))
        #expect(parts.0 == 1521)
    ...
    @Test func day21() async throws {
        let day = Day21()
        let parts = try await day.run(input: loadInput(forResource: "2024-21"))
    ...
    @Test func day22() async throws {
        let day = Day22()
        let parts = try await day.run(input: loadInput(forResource: "2024-22"))
    ...
    @Test func day23() async throws {
        let day = Day23()
        let parts = try await day.run(input: loadInput(forResource: "2024-23"))
        #expect(parts.0 == 1156)
    ...
    @Test func day24() async throws {
        let day = Day24()
        let parts = try await day.run(input: loadInput(forResource: "2024-24"))
    ...
    @Test func day25() async throws {
        let day = Day25()
        let parts = try await day.run(input: loadInput(forResource: "2024-25"))
        #expect(parts.0 == 3395)
    }
