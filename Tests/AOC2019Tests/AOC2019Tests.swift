...
@Suite struct AOC2019Tests {
    @Test func day01() async throws {
        let day = Day01()
        let parts = try await day.run(fileName: "2019-01.txt")
    ...
    @Test func day02() async throws {
        let day = Day02()
        let parts = try await day.run(fileName: "2019-02.txt")
    ...
    @Test func day03() async throws {
        let day = Day03()
        let parts = try await day.run(fileName: "2019-03.txt")
        #expect(parts.0 == 489)
    ...
    @Test func day04() async throws {
        let day = Day04()
        let parts = try await day.run(fileName: "2019-04.txt")
        #expect(parts.0 == 1748)
        #expect(parts.1 == 1180)
    }
    ...
    @Test func day05() async throws {
        let day = Day05()
        let parts = try await day.run(fileName: "2019-05.txt")
    ...
    @Test func day06() async throws {
        let day = Day06()
        let parts = try await day.run(fileName: "2019-06.txt")
    ...
    @Test func day07() async throws {
        let day = Day07()
        let parts = try await day.run(fileName: "2019-07.txt")
    ...
    @Test func day08() async throws {
        let day = Day08()
        let parts = try await day.run(fileName: "2019-08.txt")
        #expect(parts.0 == 1703)
...
"""))
    ...
    @Test func day09() async throws {
        let day = Day09()
        let parts = try await day.run(fileName: "2019-09.txt")
    ...
    @Test func day10() async throws {
        let day = Day10()
        let parts = try await day.run(fileName: "2019-10.txt")
        #expect(parts.0 == 326)
        #expect(parts.1 == 1623)
    }
    ...
    @Test func day11() async throws {
        let day = Day11()
        let parts = try await day.run(fileName: "2019-11.txt")
        #expect(parts.0 == 2184)
        #expect(parts.1.contains("""
...
"""))
    ...
    @Test func day12() async throws {
        let day = Day12()
        let parts = try await day.run(fileName: "2019-12.txt")
    ...
    @Test func day13() async throws {
        let day = Day13()
        let parts = try await day.run(fileName: "2019-13.txt")
        #expect(parts.0 == 398)
    ...
    @Test func day14() async throws {
        let day = Day14()
        let parts = try await day.run(fileName: "2019-14.txt")
    ...
    @Test func day15() async throws {
        let day = Day15()
        let parts = try await day.run(fileName: "2019-15.txt")
        #expect(parts.0 == 262)
        #expect(parts.1 == 314)
    }
    ...
    @Test func day16() async throws {
        let day = Day16()
        let parts = try await day.run(fileName: "2019-16.txt")
    ...
    @Test func day17() async throws {
        let day = Day17()
        let parts = try await day.run(fileName: "2019-17.txt")
        #expect(parts.0 == 4800)
