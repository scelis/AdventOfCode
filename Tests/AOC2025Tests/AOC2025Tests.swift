...
@Suite struct AOC2025Tests {
    @Test func day01() async throws {
        let day = Day01()
        let parts = try await day.run(fileName: "2025-01.txt")
        #expect(parts.0 == 1052)
        #expect(parts.1 == 6295)
    }
    ...
    @Test func day02() async throws {
        let day = Day02()
        let parts = try await day.run(fileName: "2025-02.txt")
    ...
    @Test func day03() async throws {
        let day = Day03()
        let parts = try await day.run(fileName: "2025-03.txt")
    ...
    @Test func day04() async throws {
        let day = Day04()
        let parts = try await day.run(fileName: "2025-04.txt")
        #expect(parts.0 == 1389)
        #expect(parts.1 == 9000)
    }
    ...
    @Test func day05() async throws {
        let day = Day05()
        let parts = try await day.run(fileName: "2025-05.txt")
        #expect(parts.0 == 567)
    ...
    @Test func day06() async throws {
        let day = Day06()
        let parts = try await day.run(fileName: "2025-06.txt")
    ...
    @Test func day07() async throws {
        let day = Day07()
        let parts = try await day.run(fileName: "2025-07.txt")
        #expect(parts.0 == 1628)
    ...
    @Test func day08() async throws {
        let day = Day08()
        let parts = try await day.run(fileName: "2025-08.txt")
    ...
    @Test func day09() async throws {
        let day = Day09()
        let parts = try await day.run(fileName: "2025-09.txt")
    ...
    @Test func day10() async throws {
        let day = Day10()
        let parts = try await day.run(fileName: "2025-10.txt")
        #expect(parts.0 == 401)
        #expect(parts.1 == 0)
    }
}
