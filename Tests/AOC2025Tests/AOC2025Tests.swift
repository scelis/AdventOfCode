...
@Suite struct AOC2025Tests {
    @Test func day01() async throws {
        let day = Day01()
        let parts = try await day.run(input: loadInput(forResource: "2025-01"))
        #expect(parts.0 == 1052)
        #expect(parts.1 == 6295)
    }
    ...
    @Test func day02() async throws {
        let day = Day02()
        let parts = try await day.run(input: loadInput(forResource: "2025-02"))
    ...
    @Test func day03() async throws {
        let day = Day03()
        let parts = try await day.run(input: loadInput(forResource: "2025-03"))
    ...
    @Test func day04() async throws {
        let day = Day04()
        let parts = try await day.run(input: loadInput(forResource: "2025-04"))
        #expect(parts.0 == 1389)
        #expect(parts.1 == 9000)
    }
    ...
    @Test func day05() async throws {
        let day = Day05()
        let parts = try await day.run(input: loadInput(forResource: "2025-05"))
        #expect(parts.0 == 567)
    ...
    @Test func day06() async throws {
        let day = Day06()
        let parts = try await day.run(input: loadInput(forResource: "2025-06"))
    ...
    @Test func day07() async throws {
        let day = Day07()
        let parts = try await day.run(input: loadInput(forResource: "2025-07"))
        #expect(parts.0 == 1628)
    ...
    @Test func day08() async throws {
        let day = Day08()
        let parts = try await day.run(input: loadInput(forResource: "2025-08"))
    ...
    @Test func day09() async throws {
        let day = Day09()
        let parts = try await day.run(input: loadInput(forResource: "2025-09"))
    ...
    @Test func day10() async throws {
        let day = Day10()
        let parts = try await day.run(input: loadInput(forResource: "2025-10"))
        #expect(parts.0 == 401)
        #expect(parts.1 == 0)
    }
    ...
    @Test func day11() async throws {
        ...
        let sample1 = try await day.run(input: loadInput(forResource: "2025-11-sample-1"))
        #expect(sample1.0 == 5)

        let sample2 = try await day.run(input: loadInput(forResource: "2025-11-sample-2"))
        #expect(sample2.1 == 2)

        let real = try await day.run(input: loadInput(forResource: "2025-11"))
        #expect(real.0 == 552)
