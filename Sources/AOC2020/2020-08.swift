...
struct Day08: Day {
    ...
    func run(input: String) async throws -> (Int, Int) {
        ...
        async let p1 = part1(instructions: instructions)
        async let p2 = part2(instructions: instructions)
        return try await (p1, p2)
    }

    func part1(instructions: [Instruction]) async throws -> Int {
    ...
    func part2(instructions: [Instruction]) async throws -> Int {
        var i = 0
        while true {
