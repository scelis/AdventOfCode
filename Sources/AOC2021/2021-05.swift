...
struct Day05: Day {
    ...
    func calculateOverlaps(input: String, allowDiagonals: Bool) -> Int {
    ...
    func part1(input: String) async throws -> Int {
        return calculateOverlaps(input: input, allowDiagonals: false)
    }

    func part2(input: String) async throws -> Int {
        return calculateOverlaps(input: input, allowDiagonals: true)
    }
}
